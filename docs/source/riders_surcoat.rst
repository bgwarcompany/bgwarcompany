...
.. figure:: ../images/riders_surcoat.svg
   :name: riders_surcoat
   :alt: Diagram of the rider's surcoat
...
.. figure:: ../images/riders_specs.svg
   :name: riders_specs
   :alt: Diagram of the rider's surcoat showing the positioning of the stars and stripes
   :figclass: align-center
   :align: center
   :scale: 60 %
...
.. figure:: ../images/riders_panel_stripe.svg
   :name: riders_panel_stripe
   :alt: Diagram of the stripe panel of the rider's surcoat
   :figclass: align-center
   :align: center
   :scale: 60 %
